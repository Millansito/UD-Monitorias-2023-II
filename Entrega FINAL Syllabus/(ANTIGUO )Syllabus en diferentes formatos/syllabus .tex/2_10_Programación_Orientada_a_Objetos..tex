...
\noindent {\sc Espacio Académico:} {\bf Programación Orientada a Objetos} \\
\noindent Código del Espacio: {\bf 10} \qquad Número de Créditos: {\bf 3} \\
...
\noindent Horas Trabajo Directo: {\bf 2} \\ 
          Horas Trabajo Colaborativo: {\bf 4} \\ 
