...
\noindent {\sc Espacio Académico:} {\bf Trabajo de Grado II} \\
\noindent Código del Espacio: {\bf 17602} \qquad Número de Créditos: {\bf 3} \\
...
\noindent Horas Trabajo Directo: {\bf 0} \\ 
          Horas Trabajo Colaborativo: {\bf 0} \\ 
		  Horas Trabajo Autónomo: {\bf 9} \\
