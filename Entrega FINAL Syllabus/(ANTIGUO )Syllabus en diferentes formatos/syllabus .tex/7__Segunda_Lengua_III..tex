...
\noindent {\sc Espacio Académico:} {\bf Segunda Lengua III} \\
\noindent Código del Espacio: {\bf } \qquad Número de Créditos: {\bf 2} \\
...
\noindent Horas Trabajo Directo: {\bf } \\ 
          Horas Trabajo Colaborativo: {\bf } \\ 
		  Horas Trabajo Autónomo: {\bf } \\

\noindent\rule[0.8ex]{12.1cm}{0.25pt} \par
\noindent {\sc Categoría del Espacio Académico} \\
\begin{tabular}{lclc}
Obligatorio & (X)  & Electivo       & () \\
Básico      & ()  & Complementario & (X) \\
